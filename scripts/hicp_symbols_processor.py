"""
This scripts generates dictionaries for HICP symbols. Content of strings was copied from eurostat webpage
"""
...
CP00	All-items HICP
	...
	CP05404	Repair of glassware, tableware and household utensils
	...
	CP0953_0954	Miscellaneous printed matter; stationery and drawing materials
	...
	GD	Goods (overall index excluding services)
	FOOD	Food including alcohol and tobacco
	FOOD_P	Processed food including alcohol and tobacco
	FOOD_P_X_ALC_TBC	Processed food excluding alcohol and tobacco
	FOOD_NP	Unprocessed food
	FOOD_S	Seasonal food
	IGD	Industrial goods
	IGD_NNRG	Non-energy industrial goods
	IGD_NNRG_D	Non-energy industrial goods, durables only
	IGD_NNRG_SD	Non-energy industrial goods, semi-durables only
	IGD_NNRG_ND	Non-energy industrial goods, non-durables only
	NRG	Energy
	ELC_GAS	Electricity, gas, solid fuels and heat energy
	FUEL	Liquid fuels and fuels and lubricants for personal transport equipment
	SERV	Services (overall index excluding goods)
	SERV_COM	Services related to communication
	SERV_HOUS	Services related to housing
	SERV_MSC	Services - miscellaneous
	SERV_REC	Services related to recreation, including repairs and personal care
	SERV_REC_X_HOA	Services related to recreation and personal care, excluding package holidays and accommodation
	SERV_REC_HOA	Services related to package holidays and accommodation
	SERV_TRA	Services related to transport
	NRG_FOOD_NP	Energy and unprocessed food
	NRG_FOOD_S	Energy and seasonal food
	EDUC_HLTH_SPR	Education, health and social protection
	FROOPP	Frequent out-of-pocket purchases
	TOT_X_FOOD_S	Overall index excluding seasonal food
	TOT_X_ALC_TBC	Overall index excluding alcohol and tobacco
	TOT_X_TBC	Overall index excluding tobacco
	...
	TOT_X_NRG_FOOD_S	Overall index excluding energy and seasonal food
	TOT_X_FUEL	Overall index excluding liquid fuels and lubricants for personal transport equipment
	TOT_X_HOUS	Overall index excluding housing, water, electricity, gas and other fuels
	TOT_X_EDUC_HLTH_SPR	Overall index excluding Education, health and social protection
	TOT_X_FROOPP	Overall index excluding frequent out-of-pocket purchases
	AP	Administered prices
	APF	Fully administered prices
	APM	Mainly administered prices
	TOT_X_AP	Overall index excluding administered prices
	TOT_X_APF	Overall index excluding fully administered prices
	TOT_X_APM	Overall index excluding mainly administered prices
"""
...
EU	European Union (EU6-1972, EU9-1980, EU10-1985, EU12-1994, EU15-2004, EU25-2006, EU27-2013, EU28)
	...
	SE	Sweden
	UK	United Kingdom
	EEA	European Economic Area (EEA18-2004, EEA28-2006, EEA30-2013, EEA31)
	IS	Iceland
	NO	Norway
	CH	Switzerland
	ME	Montenegro
...
def proccess():
    print("---------------------------")
    print("classification symbols")
    print("---------------------------")
    print("{")

    for l in classification_symbols_str.split("\n"):
        line_array = l.strip().split("\t")

        if len(line_array) == 2:
            print(""""%s": "%s",""" % (line_array[0], line_array[1]))
    ...
    for l in geo_symbols_str.split("\n"):
        line_array = l.strip().split("\t")
    ...
    print("---------------------------")
    print("index year symbols")
    print("---------------------------")
    print("{")

    for l in based_index_symbols_str.split("\n"):
        line_array = l.strip().split("\t")
